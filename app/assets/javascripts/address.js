...
var ViewProduct ={
  ...
  setview: function(product_info){
    ...
    product["product_slug"] = product_info.slug;
  ...
  render: function(){
    ...
    if(saved_cookies !=""){
      ...
      jQuery.each(list_views,function(index,value){
        ...
        value_link_display = value.product_slug?value.product_slug:value.product_id;
        li = $("<li></li>");
        link_a = $("<a></a>").attr("href","/pro/" + value_link_display);
